...
convention already used across this project's other services and the main
Node app — even though that's not idiomatic Python naming, matching the
cross-service JSON contract directly is worth more here than PEP8 purity.
"""
