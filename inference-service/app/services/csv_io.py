...
The column set mirrors the main app's own underlyings CSV export
(Ticker,ISIN,Name,Sector,Region,SpotPrice,Currency,ImpliedVol3m,DividendYield,
VolatilityScore,Reasoning) so that file can be imported here with just an
added AssetClass column — `Ticker` is accepted as an alias for `Code` for
exactly that migration path.
"""
import csv
import io
