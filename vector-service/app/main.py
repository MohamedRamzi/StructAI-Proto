...
from .routers import api_keys, auth, embedding_config, instruments, status, users
...
async def http_exception_handler(_request: Request, exc: HTTPException):
    ...
    {"success": false, "error": ...} convention, shared with the main Node
    app and quotation-service."""
